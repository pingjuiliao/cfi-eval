...
bin_cptr_overwrite = os.path.dirname(__file__) + "/callback_cptr_overwrite"

def test_callback_cptr_overwrite(hijack_func_name):
...
def benchmarking(verbose=False):
    ...
    for arg in arg_cptr_overwrite:
        r = test_callback_cptr_overwrite(arg)
        results.append(r)

...
bin_cptr_reuse = os.path.dirname(__file__) + "/callback_cptr_reuse"

def test_callback_cptr_reuse(func_tuple):
...
def benchmarking(verbose=False):
    ...
    results.append("###########\n # Testing callback_cptr_reuse\n###\n")
    for arg in arg_cptr_reuse:
        r = test_callback_cptr_reuse(arg)
        results.append(r)
